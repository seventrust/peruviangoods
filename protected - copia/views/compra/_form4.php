...
<!--            <th>
            ...
            <th>
                <div class="row">
                    <?php echo $form->labelEx($member,'Codigo'); ?>
                    <?php echo $form->textField($member,'CodProducto'); ?>
            ...
            <th>
                 <?php echo $form->labelEx($member,'UniMedida'); ?>
                <?php echo $form->textField($member,'UniMedida'); ?>
                <?php echo $form->error($member,'UniMedida'); ?>
            </th>
               
            <th>
                 <?php echo $form->labelEx($member,'Cantidad'); ?>
                <?php echo $form->textField($member,'Cantidad'); ?>
                <?php echo $form->error($member,'Cantidad'); ?>
            </th>
            
            <th>
                 <?php echo $form->labelEx($member,'Precio'); ?>
                <?php echo $form->textField($member,'Precio'); ?>
                <?php echo $form->error($member,'Precio'); ?>
            </th>
            <th>
                 <?php echo $form->labelEx($member,'SubTotal'); ?>
                <?php echo $form->textField($member,'SubTotal'); ?>
                <?php echo $form->error($member,'SubTotal'); ?>
            </th>
        </table>
        </div>
