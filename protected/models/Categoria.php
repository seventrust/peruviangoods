...
class Categoria extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('CodCategoria, Descripcion, Estatus', 'required'),
			array('CodCategoria', 'length', 'max'=>10),
			array('Descripcion', 'length', 'max'=>20),
			array('Estatus', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('Id, CodCategoria, Descripcion, Estatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
//                    'categoria' => array(self::HAS_MANY, 'Categoria', 'CodCategoria')
                    'producto'=>array(self::BELONGS_TO, 'producto', 'CodCategoria'),
