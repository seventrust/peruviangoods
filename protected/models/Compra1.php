...
class Compra extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
//            array('NumCompra, CodProveedor, CodBodega, Fecha, Vencimiento, ForPago, TotExento, TotDescuento, TotNeto, TotIva, TotImpuesto, TotRetencion, Total', 'required'),
